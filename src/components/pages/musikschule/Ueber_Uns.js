    ...
    render() {
        return (
            <div>
                ...
                <p>Klavier (E-Piano, Keyboard)</p>

                <p>Gitarre (E-Gitarre, Ukulele)</p>


                <p>Schlagzeug (Cajon, Perkussion)</p>


                <p>Gesang</p>


                <p>Flöte (Querflöte, Blockflöte)</p>


                <p>Unsere Unterrichtskonzepte bestehen aus einer gesunden Mischung von bewährtem und eigens (auch individuell auf jeden Schüler zugeschnitten) entwickeltem Material. Notenlesen ist kein Muss, um ein Hobby- oder Profimusiker zu werden! Jedoch verbinden wir mit unseren Lehrkonzepten für Kinder und Erwachsene, ob Neu- oder Wiedereinsteiger, das Notenlesen mit dem Spielen-nach-Gehör, deshalb sind wir in der Lage, jeden Schüler dort abzuholen, wo er gerade steht.</p>


                <p>Wir helfen allen weiter,</p>

                <p>…die das Musizieren für sich neu, bzw. wieder neu entdecken möchten.</p>

                <p>…die sich auf bestimmte musikalische Prüfungen vorbereiten wollen (Musikabi, Aufnahmeprüfungen…)</p>

                <p>…die die moderne Liedbegleitung (speziell auch für Gottesdienste) erlernen möchten.</p>

                <p>…die an Harmonien, Rhythmik und Arrangements bisher gescheitert sind.</p>

                <p>…die wissen möchten, wie Band-Arbeit funktioniert und sein Instrument im Bandkontext gespielt werden muss.</p>
                ...
                <p>…wir haben eine besondere Liebe und Sensibilität für Menschen mit Lernschwächen und Behinderungen und sehen es als eine ehrenvolle Aufgabe an, für sie und mit ihnen Konzepte zu entwickeln, sie zu fördern und herauszufordern.</p>
