        ...
        return (
            <div>
                ...
                <Collapsible trigger={<Img_text img={bass} text="E-Bass" />} open="true">
                    <h3 className="b" style={{ backgroundColor: "transparent" }}>E-Bass (ab 4. Klasse)</h3>
                    ...
                    <h3 className="b" style={{ backgroundColor: "transparent" }}>Lehrer</h3>
                ...
                <Collapsible trigger={<Img_text img={flute} text="Flöte" />}>
                    <h3 className="b" style={{ backgroundColor: "transparent" }}>Blockflöte</h3>
                    <h3 className="b" style={{ backgroundColor: "transparent" }}>Querflöte (ab 8 Jahre)</h3>
                ...
                <Collapsible trigger={<Img_text img={karaoke} text="Gesang" />}>
                    <h3 className="b" style={{ backgroundColor: "transparent" }}>Gesang (ab 4. Klasse)</h3>
                ...
                <Collapsible trigger={<Img_text img={gitarre} text="Gitarre" />}>
                    <h3 className="b" style={{ backgroundColor: "transparent" }}>Klassische Gitarre (ab 1. Klasse)</h3>
                    ...
                    <h3 className="b" style={{ backgroundColor: "transparent" }}>Rhythmusgitarre (ab 4. Klasse)</h3>
                    ...
                    <h3 className="b" style={{ backgroundColor: "transparent" }}>E-Gitarre (ab 4. Klasse)</h3>
                ...
                <Collapsible trigger={<Img_text img={piano} text="Klavier" />}>
                    <h3 className="b" style={{ backgroundColor: "transparent" }}>Klavier (ab 1. Klasse)</h3>
                    ...
                    <h3 className="b" style={{ backgroundColor: "transparent" }}>E-Piano (ab 1. Klasse)</h3>
                    ...
                    <h3 className="b" style={{ backgroundColor: "transparent" }}>Keyboard (ab 1. Klasse)</h3>
                ...
                <Collapsible trigger={<Img_text img={drums} text="Schlagzeug" />}>
                    <h3 className="b" style={{ backgroundColor: "transparent" }}>Schlagzeug (ab 1. Klasse)</h3>
