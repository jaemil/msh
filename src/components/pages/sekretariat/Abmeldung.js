...
export default class Abmeldung extends Component {
    render() {
        return (
            <div>
                ...
                <p>Im Instrumental - /Gesangsunterricht beginnt das Semester am 01.Oktober / 01.April und endet am 31.März / 30.September.</p></div>
            </div>
        )
    }
}
